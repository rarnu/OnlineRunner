...
function Graph(isDark, value, width, height, rangeX, rangeY) {
    var autoRange = false;
    ...
    this.redraw = function () {
        if (this.points.length > 1) {
            ...
            //Draw all the points
            stage.strokeStyle = this.isDark ? "#00FF00" : "#2980b9";
            stage.lineWidth = 1;
            stage.beginPath();
    ...
    var moveMouse = function (event) {
        ...
        //Draw the coordinate
        stage.fillStyle = this.isDark? "#00FF00" : "#2980b9";
        stage.beginPath();
        ...
        stage.closePath();
        stage.fill();
        stage.fillStyle = this.isDark ? "#FFF": "#000";
        stage.strokeStyle = this.isDark? "#212121": "#FFF";
        stage.lineWidth = 4;
    ...
    if (this.canvas.getContext) {
        ...
        this.canvas.style.backgroundColor = this.isDark ? "#212121": "#FFF";
...
var XCalc = (function () {
    ...
    worker.graphExpression = function (isDark, value, width, height, rangeX, rangeY) {
        return new Graph(isDark, value, width, height, rangeX, rangeY);
    };
